            ...
            return (
              ...
              >
                ...
                <div className="hidden lg:flex flex-col items-center">
                  ...
                  <div className="w-0.5 h-full min-h-[200px] bg-gradient-to-b from-primary via-border to-border" />
                </div>
    ...
    >
      ...
      <ul className={`space-y-2 ${alignment === "right" ? "lg:text-right" : ""}`}>
        {experience.achievements.map((achievement, i) => (
          <li 
            key={i}
            className={`flex items-start gap-2 text-sm text-foreground ${alignment === "right" ? "lg:flex-row-reverse" : ""}`}
          >
